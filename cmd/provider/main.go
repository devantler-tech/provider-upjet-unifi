...
import (
	...
	apisCluster "github.com/devantler-tech/provider-upjet-unifi/apis/cluster"
	apisNamespaced "github.com/devantler-tech/provider-upjet-unifi/apis/namespaced"
	"github.com/devantler-tech/provider-upjet-unifi/config"
	"github.com/devantler-tech/provider-upjet-unifi/internal/clients"
	controllerCluster "github.com/devantler-tech/provider-upjet-unifi/internal/controller/cluster"
	controllerNamespaced "github.com/devantler-tech/provider-upjet-unifi/internal/controller/namespaced"
	"github.com/devantler-tech/provider-upjet-unifi/internal/features"
	"github.com/devantler-tech/provider-upjet-unifi/internal/version"
)
...
func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for UniFi").DefaultEnvars()
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped UniFi APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced UniFi APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped UniFi controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced UniFi controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped UniFi controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced UniFi controllers")
	}
