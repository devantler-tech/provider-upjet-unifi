...
type WlanInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/devantler-tech/provider-upjet-unifi/apis/cluster/wlan/v1alpha1.ApGroup
	// +listType=set
	...
	// +kubebuilder:validation:Optional
	ApGroupIdsRefs []v1.Reference `json:"apGroupIdsRefs,omitempty" tf:"-"`

	// Selector for a list of ApGroup in wlan to populate apGroupIds.
	// +kubebuilder:validation:Optional
	ApGroupIdsSelector *v1.Selector `json:"apGroupIdsSelector,omitempty" tf:"-"`
