...
func (mg *Server) GetTerraformResourceType() string {
	return "unifi_vpn_server"
}

// GetConnectionDetailsMapping for this Server
func (tr *Server) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"l2tp.pre_shared_key": "l2tp.preSharedKeySecretRef", "openvpn.auth_key": "status.atProvider.openvpn.authKey", "openvpn.ca_crt": "status.atProvider.openvpn.caCrt", "openvpn.ca_key": "status.atProvider.openvpn.caKey", "openvpn.dh_key": "status.atProvider.openvpn.dhKey", "openvpn.server_crt": "status.atProvider.openvpn.serverCrt", "openvpn.server_key": "status.atProvider.openvpn.serverKey", "openvpn.shared_client_crt": "status.atProvider.openvpn.sharedClientCrt", "openvpn.shared_client_key": "status.atProvider.openvpn.sharedClientKey", "wireguard.private_key": "wireguard.privateKeySecretRef"}
}
